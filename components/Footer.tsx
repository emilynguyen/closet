...
export function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 right-0 h-8 grid grid-cols-2 items-center px-4 text-xs uppercase text-black bg-[var(--background)] border-t border-black whitespace-nowrap">
